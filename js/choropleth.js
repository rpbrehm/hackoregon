...
var title = svg.append("svg:text")
    ...
    .attr("class", "title")
    ;
// Set the object title to the document title.
...
// Load the county codes to populate the
d3.json("json/county_codes.json", function(json) {
    county_codes = json;
});

// Add the data to the counties file
